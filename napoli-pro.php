...
class Napoli_Pro {
	...
	static function constants() {
		...
		define( 'NAPOLI_PRO_VERSION', '2.2.2' );
	...
	static function includes() {
		...
		require_once NAPOLI_PRO_PLUGIN_DIR . 'includes/modules/class-author-bio.php';
		require_once NAPOLI_PRO_PLUGIN_DIR . 'includes/modules/class-block-colors.php';
