...
class Napoli_Pro_Magazine_Columns_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				'classname' => 'napoli_magazine_columns',
	...
	function widget( $args, $instance ) {
		...
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'widget_napoli_magazine_columns', 'widget' );
		}
		if ( ! is_array( $cache ) ) {
			$cache = array();
		}
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'widget_napoli_magazine_columns', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'highlight_post' ); ?>">
				...
				<?php esc_html_e( 'Highlight first post (big image + excerpt)', 'napoli-pro' ); ?>
			</label>
		</p>
	...
	public function delete_widget_cache() {
		...
		wp_cache_delete( 'widget_napoli_magazine_columns', 'widget' );
