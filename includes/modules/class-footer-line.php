...
class Napoli_Pro_Footer_Line {
	...
	static function setup() {
		...
		add_action( 'napoli_footer_menu', array( __CLASS__, 'display_footer_navigation' ) );
	...
	static function display_footer_text() {
		...
		if ( true == $theme_options['credit_link'] ) :
			...
			if ( function_exists( 'napoli_footer_text' ) ) :
	...
	static function footer_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'napoli_pro_section_footer', array(
			'title'    => __( 'Footer Settings', 'napoli-pro' ),
			'priority' => 90,
		...
		$wp_customize->add_setting( 'napoli_theme_options[footer_text]', array(
			'default'           => '',
			'type'           	=> 'option',
			'transport'         => 'refresh',
		...
		$wp_customize->add_control( 'napoli_theme_options[footer_text]', array(
			'label'    => __( 'Footer Text', 'napoli-pro' ),
			'section'  => 'napoli_pro_section_footer',
			'settings' => 'napoli_theme_options[footer_text]',
			'type'     => 'textarea',
			'priority' => 30,
			)
		);
		...
		$wp_customize->add_setting( 'napoli_theme_options[credit_link]', array(
			'default'           => true,
			'type'           	=> 'option',
			'transport'         => 'refresh',
		...
		$wp_customize->add_control( 'napoli_theme_options[credit_link]', array(
			'label'    => __( 'Display Credit Link to ThemeZee on footer line', 'napoli-pro' ),
			'section'  => 'napoli_pro_section_footer',
			'settings' => 'napoli_theme_options[credit_link]',
			'type'     => 'checkbox',
			'priority' => 40,
			)
		);
...
// Run Class.
add_action( 'init', array( 'Napoli_Pro_Footer_Line', 'setup' ) );

// Register footer navigation in backend.
add_action( 'after_setup_theme', array( 'Napoli_Pro_Footer_Line', 'register_footer_menu' ), 30 );
