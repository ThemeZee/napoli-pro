...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Napoli_Pro_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'napoli_pro_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'napoli-pro' ),
				'next'     => esc_html__( 'Next Font', 'napoli-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'napoli-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Napoli_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Napoli_Pro_Custom_Fonts::get_google_fonts();
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'napoli-pro-custom-font-control', NAPOLI_PRO_PLUGIN_URL . 'assets/js/custom-font-control.js', array( 'customize-controls' ), NAPOLI_PRO_VERSION, true );
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'napoli-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'napoli-pro' ); ?>">
	  							<?php
