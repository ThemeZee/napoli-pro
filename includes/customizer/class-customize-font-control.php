...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Napoli_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => __( 'Previous Font', 'napoli-pro' ),
				'next' => __( 'Next Font', 'napoli-pro' ),
				'standard' => _x( 'Default', 'default font button', 'napoli-pro' ),
			);
			...
			// Set Fonts.
			$this->fonts = Napoli_Pro_Custom_Font_Lists::get_fonts( $theme_options['available_fonts'] );
